...
namespace Balakin.VSOutputEnhancer.Tests.UnitTests
{
    ...
    public class ClassificationFormatTests
    {
        private static readonly IReadOnlyDictionary<Type, String> ClassificationTypeExpectedNames = new Dictionary<Type, String>
        {
            ...
            { typeof(BuildStartedSuccessFormatDefinition), "Output enhancer: Build started and succeeded" },
            { typeof(BuildStartedWarningFormatDefinition), "Output enhancer: Build started and finished with warnings" },
            { typeof(BuildStartedErrorFormatDefinition), "Output enhancer: Build started and failed" },
